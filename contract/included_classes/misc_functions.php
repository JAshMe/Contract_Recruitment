...
$query_mysql1 = process_query ($connection,"reg_e_17",$mysql_query1);
...
$accod = get_value ( $connection, "reg_e_17", "accomodation" , "reg_type_accod", "regno", $regno );
...
$curr_reg_db = "reg_e_15";
$prev_reg_db = "reg_o_15";
?>
