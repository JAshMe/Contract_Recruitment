	...
	*/
	...
	class BARCODE
	{
		...
		function __construct($encoding="EAN-13")
		{
			...
			//to hide human readable text below bar code
...
*/
		...
		*/
		...
		function _c93Barcode($barnumber,$scale=1,$file="",$checkdigit=false)
		{
			...
			{
				if(!empty($file))
					@imagepng($im,"getbarcode/codes/".$file.".".$this->_format);
				else
					@imagepng($im);
			}
			...
			{
				if(!empty($file))
					@imagegif($im,"getbarcode/codes/".$file.".".$this->_format);
				else
					@imagegif($im);
			}
			...
			{
				if(!empty($file))
					@imagejpeg($im,"getbarcode/codes/".$file.".".$this->_format);
				else
					@imagejpeg($im);
			}
		...
		function _c39Barcode($barnumber,$scale=1,$file="",$checkdigit=false)
		{
			...
			{
				if(!empty($file))
					@imagejpeg($im,"getbarcode/codes/"."getbarcode/codes/".$file.".".$this->_format);
				else
					@imagejpeg($im);
			}
		...
		function _c128Barcode($barnumber,$scale=1,$file="")
		{
			...
			{
				if(!empty($file)) {
					@imagepng($im,"getbarcode/codes/"."getbarcode/codes/".$file.".".$this->_format);
					//echo "Image created ";
				}
