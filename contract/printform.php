...
?>
        ...
        <div class="form" style="width:900px;page-break-before: always">
                <table width="100%" border="0">
                        <tr>
                                <td width="12%" height="87"><div align="center"><img alt="MNNIT Logo" src="logo-MNNIT.png" width="110" height="105" /></div></td>
                                <td width="73%">
                                        <h3 align="center" class="style5">MOTILAL NEHRU NATIONAL INSTITUTE OF TECHNOLOGY <br /> ALLAHABAD - 211004 (INDIA)<br><br>APPLICATION FORM
                                        </h3>
                                </td>
                                <td width="8%" class="right">
                                        <table width="100%" height="25%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000"></table>
                                </td>
        ...
        <div class="row">
                ...
                <div class="col-md-8 col-xs-8">
                        <table class="table table-bordered table-striped">
                                ...
                                <tr><th>Post Applied For:</th><td><?= $post[$type];?></td></tr>
                ...
                <div class="col-md-4 col-xs-4">
                        <table class="table">
                                <div align="center"><div style="margin-top:0;margin-bottom:0"><?php echo "<img src=./photos/".$_SESSION['user'].".JPG style=\"margin-top:0px; border-width:thin;\" width=\"175\" height=\"180\" alt = \"Photo not in Records Please Upload Your Photo\" /> "; ?> </div>
<!--                                </div></div>-->
