...
.btn-register:focus {
    ...
    <div class="row" style="margin-top:-50px">
    	<div class="col-md-6 col-md-push-3">
        	<h2><center>Instruction to fill the form. <a href="formInstruction.docx">Click Here</a></center></h2>
        </div>
    </div>
