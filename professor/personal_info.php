      	...
      	<div class="form-group">
         	<label class="control-label col-sm-3" for="dob"><span class="text-danger">*</span> Post Applied For :</label>  
          	<div class="col-sm-5">
				  ...
				  <option value="10500" <?php if(isset($post_applied) && $post_applied=='10500') echo 'selected';?> >Professor AGP-10500</option>
				  <option value="HAG" <?php if(isset($post_applied) && $post_applied=='HAG') echo 'selected';?> >Professor-HAG</option>
